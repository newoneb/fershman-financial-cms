...
function parseMarkdown(markdown) {
    ...
    content = content.replace(/^(?!<[h|u|l|p|i])(.*$)/gm, '<p>$1</p>');
...
function hideLoadingIndicators() {
    const loadingElements = document.querySelectorAll('.contentful-loading');
...
function displayErrorMessage(container) {
    const message = 'Sorry, there was an error loading the content. Please try again later.';
    ...
    if (container) {
        ...
        // If no specific container, update all content containers
        const containers = [
            document.getElementById('featured-articles-container'),
            document.getElementById('articles-grid-container'),
            document.getElementById('expert-opinions-container'),
            document.getElementById('category-articles-container'),
            document.getElementById('article-content-container')
        ];
